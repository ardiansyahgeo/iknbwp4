var size = 0;
var placement = 'point';
function categories_JALANPENGEMBANGANEKSISTING_8(feature, value, size, resolution, labelText,
...
case 'Jalan Tol':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(216,22,16,1.0)', lineDash: null, lineCap: 'round', lineJoin: 'round', width: 7}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_JALANPENGEMBANGANEKSISTING_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_JALANPENGEMBANGANEKSISTING_8(feature, value, size, resolution, labelText,
